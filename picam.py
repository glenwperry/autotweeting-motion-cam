...
# Threshold          - how much a pixel has to change by to be marked as "changed" default is 10
# Sensitivity        - how many changed pixels before capturing an image, needs to be higher if noisy view default is 20
# ForceCapture       - whether to force an image to be captured every forceCaptureTime seconds, values True or False
# filepath           - location of folder to save photos
# filenamePrefix     - string that prefixes the file name for easier identification of files.
# diskSpaceToReserve - Delete oldest images to avoid filling disk. How much byte to keep free on disk.
# cameraSettings     - "" = no extra settings; "-hf" = Set horizontal flip of image; "-vf" = Set vertical flip; "-hf -vf" = both horizontal and vertical flip
threshold = 120 #default is 10, 120 gets lots of black shots and no motion cap. 100/150 worked pretty good.
sensitivity = 150 #default is 20
forceCapture = False
forceCaptureTime = 60 * 60 # Once an hour
filepath = "/home/pi/picam"
filenamePrefix = "capture"
diskSpaceToReserve = 22000 * 1024 * 1024 # Keep 40 mb free on disk (you have 32768 total)
cameraSettings = "-vf"
...
testAreaCount = 1
testBorders = [ [[10,testWidth - 10],[10,testHeight - 10]] ]  # [ [[start pixel on left side,end pixel on right side],[start pixel on top side,stop pixel on bottom side]] ***[ [[1,testWidth],[1,testHeight]] ] ***]
